  ...
  return (
    <Grid container>
      ...
      <Grid container size={{ xs: 5, sm: 12 }}>
        ...
        >
          ...
          <Stack direction="row" spacing={1}>
            ...
            />
            <Typography variant="body2">{aboutMetadata.location}</Typography>
          </Stack>
        </Grid>
      ...
      <Grid container size={{ xs: 7, sm: 12 }}>
        ...
        >
          <Stack direction="row" spacing={1}>
            <SvgIcon fontSize="small" sx={{ display: "block", margin: "auto" }}>
              <svg
                viewBox="0 0 600 535"
                version="1.1"
        ...
        >
          <Stack direction="row" spacing={1}>
            ...
            <Link variant="body2" href={`mailto:${aboutMetadata.email}`}>
              Email
            </Link>
          </Stack>
        </Grid>
